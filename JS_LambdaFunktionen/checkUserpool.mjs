    ...
    try {
        ...
        const command = new PutCommand({
            ...
            Item: {
                ...
                "strasse": attributes.address || "",        // Standard-Attribut für die Straße
                "haus_nr": attributes["custom:haus_nr"] || "", // Benutzerdefiniertes Cognito-Attribut für Hausnummer
                "plz": attributes["custom:plz"] || "",         // Benutzerdefiniertes Cognito-Attribut für Postleitzahl
